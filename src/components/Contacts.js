        ...
        <>
            <div className="jumbotron jumbotron-fluid">
                <div className="container">
                    <h1 className="display-4 text-center">Customer Database</h1>
                </div>
            </div>
            <div className="row">
                        ...
                        <tbody>
                            {
                                Object.keys(contactObjects).map((key) => (
                                    ...
                                    <tr key={key}>
                                        <td>{contactObjects[key].shopping}</td>
                                        <td>{contactObjects[key].rate}</td>
                                        <td>{contactObjects[key].number}</td>
                                        <td>{contactObjects[key].offer}</td>
